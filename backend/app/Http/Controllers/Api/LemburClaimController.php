...
class LemburClaimController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            NotificationHelper::createForMultiple(
                $approvers,
                'lembur_claim_submitted',
                'Claim Lembur Baru',
                "{$user->name} mengajukan claim lembur sebesar {$request->time} menit untuk tanggal {$request->date}.",
                [
                    'claim_id' => $claim->id,
            ...
            NotificationHelper::create(
                $user->id,
                'lembur_claim_submitted',
                'Claim Lembur Berhasil Diajukan',
                "Claim lembur Anda sebesar {$request->time} menit telah diterima dan menunggu persetujuan.",
                ['claim_id' => $claim->id, 'time' => $request->time]
            );
    ...
    public function approve($id)
    {
        try {
            ...
            NotificationHelper::create(
                $claim->user_id,
                'lembur_claim_approved',
                'Claim Lembur Disetujui',
                "Claim lembur Anda sebesar {$claim->time} menit untuk tanggal {$claim->date} telah disetujui.",
                [
                    'claim_id' => $claim->id,
    ...
    public function reject(Request $request, $id)
    {
        ...
        try {
            ...
            NotificationHelper::create(
                $claim->user_id,
                'lembur_claim_rejected',
                'Claim Lembur Ditolak',
                "Claim lembur Anda sebesar {$claim->time} menit untuk tanggal {$claim->date} telah ditolak. Alasan: {$request->reject_reason}",
                [
                    'claim_id' => $claim->id,
