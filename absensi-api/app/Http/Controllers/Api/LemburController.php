...
class LemburController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $lembur = Lembur::create([
                ...
                // Set awal sesuai lama lembur (potensi claim), 
                // tapi nanti di frontend ditandai sebagai 'pending'
    ...
    public function reject(Request $request, $id)
    {
        try {
            ...
            // UPDATE LOGIC: Set sisa_waktu_claim jadi 0 saat reject
            $lembur->update([
    ...
    public function finalApprove(Request $request, $id)
    {
        try {
            ...
            // UPDATE LOGIC: Sisa Claim tetap ada, status jadi Accepted
            $lembur->update([
    ...
    public function finalReject(Request $request, $id)
    {
        try {
            ...
            // UPDATE LOGIC: Set sisa_waktu_claim jadi 0 saat final reject
            $lembur->update([
                'final_status' => Lembur::STATUS_REJECTED,
                'sisa_waktu_claim' => 0
            ]);
